"""
Run PersonaMem text experiment from CLI.

Notebook reference:
- notebooks/experiment_personamem.ipynb
"""
...
DEFAULT_JSONL = Path("data/inputs/personamem_benchmark_text_32k_user_bundles.jsonl")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run PersonaMem text benchmark experiment (stage1/stage2)."
    )
    parser.add_argument(
        "--stage",
        choices=["1", "2", "both"],
    ...
    args.jsonl = ensure_bundle_jsonl(args.jsonl, split="benchmark_text")
